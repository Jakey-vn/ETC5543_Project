...
tibble(
  ...
  Contents = c(
    ...
    "GL accounts, Cost Center keys, Customer list, VA brand mapping",
...
For Laverton, a single row type is produced: Total Weight × Carcass Price (Farm tab only). Output rows use GL 510167 under cost Center 10501816 (Corowa) and 10501854 (Laverton) respectively.
